package app.bardia.mun.views.announcements;
...
@AnonymousAllowed
public class AnnouncementsView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public AnnouncementsView() {
        addClassName("announcements-view");
        setSizeFull();
        grid.setHeight("100%");
